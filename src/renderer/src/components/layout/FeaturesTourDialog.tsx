...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body:
      'The Dashboard surfaces what needs your attention right now: follow-ups due, overdue disclosure deadlines, and CVEs without check-ins. ' +
  ...
  },
  {
    ...
    body:
      ...
      'Drag a CVE between columns to advance it. Cross-product drags are blocked to prevent stray re-tagging.'
  },
  {
    Icon: CalendarDays,
  ...
  {
    Icon: FileText,
    title: 'Everything about a CVE in one card',
    body:
      'Click any CVE card and a centered detail panel opens with the full picture: description, technical metadata (CVSS, CWE), ' +
  ...
  },
  {
    ...
    body:
      'When you\u2019re ready to contact a vendor, click "Draft disclosure" on the CVE detail card. CVEase pre-fills a coordinated-disclosure email ' +
  ...
  },
  {
    ...
    body:
      'Set up your vendors once and they\u2019ll pre-fill new CVEs you create. Customize the default todo checklist to match your workflow. ' +
